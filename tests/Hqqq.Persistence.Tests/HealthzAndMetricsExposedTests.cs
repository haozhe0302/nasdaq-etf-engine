...
/// hqqq-persistence exposes the standard Phase 2 endpoints. The Timescale
/// connection isn't required here; the test only locks the observability
/// registration shared with Program.cs.
/// </summary>
public class HealthzAndMetricsExposedTests
{
    [Fact]
    public async Task ManagementHost_ExposesHealthzAndMetrics_ForPersistenceService()
    {
        ...
        hostBuilder.Services.AddHqqqObservability("hqqq-persistence", hostBuilder.Environment);
